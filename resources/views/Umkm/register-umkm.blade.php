    ...
    <div class="relative z-10 max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center p-6">
        ...
        <div class="text-center lg:text-left space-y-4 select-none">
            ...
            <h2 class="text-2xl lg:text-4xl font-medium text-blue-100 leading-tight font-sans">
                A world or place <br class="hidden lg:block"> to find your <br> career path
            </h2>
        </div>

        <div class="w-full max-w-md mx-auto lg:mr-0">
            <div class="bg-white/10 backdrop-blur-lg border border-white/20 px-7 pt-3 pb-2 rounded-2xl shadow-2xl relative">
                ...
                <form action="{{ route('process.register.umkm') }}" method="POST" class="space-y-4">
                    ...
                    <div class="mb-3.5">
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-11 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            ...
                            <input type="email" name="email" placeholder="XXXX@yyy.com" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full text-sm" required>
                        </div>
                    </div>

                    <!-- Name Field -->
                    <div class="mb-3.5">
                        <label class="block text-blue-200 text-sm font-semibold mb-2 ml-1">Nama</label>
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-11 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            <div class="pl-4 pr-3 text-blue-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text" name="name" placeholder="Nama anda" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full text-sm" required>
                        </div>
                    </div>
                    ...
                    <!-- UMKM Name Field -->
                    <div class="mb-3.5">
                        <label class="block text-blue-200 text-sm font-semibold mb-2 ml-1">Nama UMKM</label>
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-11 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            <div class="pl-4 pr-3 text-blue-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text" name="umkm_name" placeholder="Nama UMKM Anda" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full text-sm" required>
                        </div>
                    </div>
                    ...
                    <div class="text-sm text-blue-200 text-center mb-3">
                        Sudah memiliki akun? 
                        <a href="{{ route('login.umkm') }}" class="text-yellow-400 hover:text-yellow-300 font-bold hover:underline transition">Login</a>
                    </div>

                    <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold py-3 rounded-xl transition duration-300 shadow-lg shadow-blue-900/30 transform active:scale-95 tracking-wide text-sm">
                        Daftar
                    </button>
                </form>
