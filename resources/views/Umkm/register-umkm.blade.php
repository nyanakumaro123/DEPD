                ...
                <form action="{{ route('process.register.umkm') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            ...
                            <input type="email" name="email" placeholder="XXXX@yyy.com" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            ...
                            <input type="text" name="name" placeholder="Nama anda" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            ...
                            <input type="text" name="umkm_name" placeholder="Nama UMKM Anda" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 relative transition-all duration-200">
                            ...
                            <input id="password" name="password" type="password" placeholder="Password" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 relative transition-all duration-200">
                            ...
                            <input id="confirm_password" name="password_confirmation" type="password" placeholder="Confirm Password" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                    ...
                    <div class="text-sm text-blue-200 pt-2 text-center">
                        Sudah memiliki akun? <a href="{{ route('login.umkm') }}" class="text-yellow-400 hover:text-yellow-300 font-bold hover:underline transition">Login</a>
                    </div>
