    ...
    <div class="relative z-10 max-w-3xl mx-auto bg-white/10 backdrop-blur-lg p-8 rounded-xl shadow-lg shadow-blue-900/30 mt-6 border border-white/10">
        ...
        <form action="{{ route('umkm.projects.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="category" value="{{ old('category') }}" class="w-full bg-white/5 border border-blue-400/50 rounded-lg p-3 text-white placeholder-blue-300/70 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" placeholder="Contoh: Desain Grafis, Marketing" required>
