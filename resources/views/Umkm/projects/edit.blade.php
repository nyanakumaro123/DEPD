...
<div class="min-h-screen w-full bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-hidden relative font-sans pb-20">
    ...
    <div class="relative z-10 max-w-3xl mx-auto bg-white/10 backdrop-blur-lg p-8 rounded-xl shadow-lg shadow-blue-900/30 mt-6 border border-white/10">
        <h2 class="text-3xl font-bold mb-6 text-blue-200 font-serif">Edit Project</h2>
        ...
        <form action="{{ route('umkm.projects.update', $project) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="title" value="{{ old('title', $project->title) }}" class="w-full bg-white/5 border border-blue-400/50 rounded-lg p-3 text-white placeholder-blue-300/70 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition" required>
            ...
            <div class="mb-5">
                ...
                <textarea name="description" rows="4" class="w-full bg-white/5 border border-blue-400/50 rounded-lg p-3 text-white placeholder-blue-300/70 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition custom-scrollbar" required>{{ old('description', $project->description) }}</textarea>
            ...
            <div class="grid grid-cols-2 gap-4 mb-5">
                <div>
                    ...
                    <input type="time" name="time_start" value="{{ old('time_start', \Carbon\Carbon::parse($project->time_start)->format('H:i')) }}" class="w-full bg-white/5 border border-blue-400/50 rounded-lg p-3 text-blue-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition custom-scrollbar [color-scheme:dark]" required>
                ...
                <div>
                    ...
                    <input type="time" name="time_end" value="{{ old('time_end', \Carbon\Carbon::parse($project->time_end)->format('H:i')) }}" class="w-full bg-white/5 border border-blue-400/50 rounded-lg p-3 text-blue-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition custom-scrollbar [color-scheme:dark]" required>
            ...
            <div class="grid grid-cols-3 gap-4 mb-5">
                ...
                <div>
                    ...
                    <div class="relative flex items-center group">
                        ...
                        <input type="number" name="salary_amount" value="{{ old('salary_amount', $project->salary_amount) }}" min="0" max="999999999"
                ...
                <div>
                    ...
                    <select name="salary_frequency" class="w-full bg-white/5 border border-blue-400/50 rounded-lg p-3 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition custom-scrollbar custom-select cursor-pointer [&>option]:bg-slate-900">
                        ...
                        <option value="per_month" {{ $project->salary_frequency == 'per_month' ? 'selected' : '' }} class="bg-slate-900">Per Bulan</option>
                    </select>
            ...
            <div class="mb-7">
                ...
                <p class="text-xs text-blue-300/70 mt-1">Biarkan kosong jika tidak ingin mengubah file.</p>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" class="px-6 py-3 bg-blue-700 text-white rounded-lg hover:bg-blue-600 transition shadow-md">Update Project</button>
            </div>
        </form>
    </div>
</div>
