...
<div class="min-h-screen bg-[#fff8f0] font-sans pb-20 relative">
    ...
    <div class="fixed bottom-10 left-10">
        <a href="{{ route('edit-profile.pelamar', 1) }}" class="bg-[#355dad] hover:bg-[#2a4a8b] text-white p-5 rounded-full shadow-2xl transition transform hover:scale-110 flex items-center justify-center">
