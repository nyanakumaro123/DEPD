                ...
                <form action="{{ route('process.register.pelamar') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            ...
                            <input type="email" name="email" placeholder="applicant@example.com" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-black/20 border border-white/10 rounded-xl overflow-hidden h-12 focus-within:ring-2 focus-within:ring-blue-400 transition-all duration-200">
                            ...
                            <input type="text" name="name" placeholder="Your Name" class="w-full bg-transparent border-none focus:ring-0 text-white placeholder-blue-200/50 h-full" required>
                        </div>
                    </div>
