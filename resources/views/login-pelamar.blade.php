                ...
                <form action="" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center bg-[#eef2ff] rounded-lg overflow-hidden h-12 focus-within:ring-2 focus-within:ring-yellow-400 relative transition-all duration-200">
                            ...
                            <input id="login_password" type="password" placeholder="Password" class="w-full bg-transparent border-none focus:ring-0 text-gray-700 placeholder-gray-400 h-full">
