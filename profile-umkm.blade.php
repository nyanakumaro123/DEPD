    ...
    <nav class="bg-[#355dad] px-6 py-3 shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-8 text-white font-bold text-lg">
                ...
                <a href="/profile-umkm" class="text-white border-b-2 border-white hover:text-yellow-400 transition">Profile</a>
            ...
            <div class="h-10 w-10 rounded-full overflow-hidden border-2 border-white cursor-pointer hover:shadow-lg transition">
